...
public class RedRight {
    ...
    public static void run(HardwareMap hardwareMap , Telemetry telemetry){
        ...
        while(true)
        {
            ...
            {
                outtake.goPURPLE();
                drive.setTargetPosition(31 , -3 , Math.PI/2+0.2);
                ok=true;
            }
            ...
            if(ok2==true && drive.inPosition( 10 , 10 , 0.3) && ok3==false && topGripper.isOpen() && bottomGripper.isOpen())
            {
                ...
                drive.setTargetPosition(18.8 , -87.2 , Math.PI/2);
                outtake.goUP();
                ok3=true;
            }
            ...
            {  index=4;
                ...
                while(ok5==true)
                {
                    ...
                    if(ok6==false)
                    {
                        drive.setTargetPosition( 50 , -80 , Math.PI/2);
                        ok6=true;
                    ...
                    {
                        drive.setTargetPosition(50 , -18.55 , Math.PI/2);
                    ...
                    if(ok7==true && ok8==false && drive.localizer.getPoseEstimate().getY()>-60){extendo.setVelocity(0.8);
                        ...
                        if(extendo.encoder.getCurrentPosition()>800)extendo.setVelocity(0.4);
                    ...
                    {
                        drive.setTargetPosition(46.5 , -91.2 , Math.PI/2+0.7);
                    ...
                    if(ok13==true && topGripper.isClosed() && bottomGripper.isClosed() && ok14==false)
                    {
                        outtake.goDOWN();
                        ok14=true;
                        drive.setTargetPosition( 51 , -85 , Math.PI/2+0.7);
                    }
