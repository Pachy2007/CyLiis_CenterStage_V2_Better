...
public class RedLeft {
    ...
    public static void run(HardwareMap hardwareMap){
        ...
        while(true)
        {
            ...
            {
                outtake.goPURPLE();
                drive.setTargetPosition(34 , 19 , Math.PI/2+0.4);
                ok=true;
            }
            ...
            if(ok2==true && drive.inPosition(10 , 10 , 10) && ok3==false)
            {
                ...
                drive.setTargetPosition(29.8 , -87.7 , Math.PI/2);
                outtake.goUP();
                ok3=true;
            }
            if(Math.abs(outtake.lift.getPosition()-Lift.outPosition)<60 && ok3==true && drive.inPosition( ) && ok4==false)
            {
            ...
            if(ok4==true && topGripper.isClosed() && bottomGripper.isClosed() && ok5==false){
                drive.setTargetPosition(33.6 , -84 , Math.PI/2);}
            ...
            {  index=4;
                ...
                while(ok5==true)
                {
                    ...
                    if(ok6==false)
                    {
                        drive.setTargetPosition( 49.5 , -80 , Math.PI/2);
                        ok6=true;
                    ...
                    {
                        drive.setTargetPosition(49.5 , -18.35 , Math.PI/2);
                    ...
                    if(ok7==true && ok8==false && drive.localizer.getPoseEstimate().getY()>-60){extendo.setVelocity(0.8);
                        ...
                        if(extendo.encoder.getCurrentPosition()>800)extendo.setVelocity(0.5);
                        if(extendo.encoder.getCurrentPosition()>950)extendo.setVelocity(0.3);
                    ...
                    {
                        drive.setTargetPosition(48.5 , -91.7 , Math.PI/2+0.75);
