...
public class TestTrajectory{
    ...
    public static void run(HardwareMap hardwareMap , Telemetry telemetry){
        ...
        while(true)
        {
            telemetry.addData("L" , outtake.extension.state);
            ...
            {
                outtake.goPURPLE();
            drive.setTargetPosition(38.7 , -13 , -Math.PI/2);
            ok=true;
            }
            ...
            if(ok2==true && drive.inPosition(10 , 10 , 0.3) && ok3==false)
            {
                ...
                drive.setTargetPosition(28.83 , 87.5 , -Math.PI/2);
                outtake.goUP();
                ok3=true;
            }
            ...
            {  index=4;
                ...
                while(ok5==true)
                {
                    ...
                    {
                        drive.setTargetPosition(51 , 19 , -Math.PI/2);
                        if(tiemrParking.seconds()>25){
                            ok6=true;
                            ok7=true;
                            ok8=true;
                    ...
                    if(ok9==true && ok10==false)
                    {
                        nr00=false;
                        ok100=false;
                        extendo.setIN();intake.setState(Intake.State.REVERSE);
                    ...
                    {
                        drive.setTargetPosition(48 , 91.7 , -Math.PI/2-0.7);
                    ...
                    if(ok13==true && topGripper.isClosed() && bottomGripper.isClosed() && ok14==false)
                    {
                        outtake.goDOWN();
                        ok14=true;
                        drive.setTargetPosition( 51 , 88 , -Math.PI/2-0.7);
                    }
